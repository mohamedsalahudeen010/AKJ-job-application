...
const {baseUrl,stud,setStud}=useContext(AKJContext)
    ...
    const logInFunc = async (user) => {
      try {
        ...
        if (data.message === "User logged in successfully") {
          setStud(data.student);
       
          localStorage.setItem("email",data.student.email);
          localStorage.setItem("name",data.student.firstName);
          localStorage.setItem("token",data.token);
          localStorage.setItem("data",JSON.stringify(data.student));
          dispatch(fetchStudentSuccess(data.student.firstName))
      ...
      <div className='welcome-board-login'>
        ...
        <div>
          <form onSubmit={handleSubmit} className="form-signIn">
            ...
            onClick={()=>navigate("/")}>Student Login</div>
          ...
          >
            ...
            <div>
        <p>Click Here To SignUp <button onClick={()=>navigate("/signUpStudent")}
